...
public class XSSFSheetToCSVDataFlowNodeFactory implements DataFlowNodeFactory
{
    public XSSFSheetToCSVDataFlowNodeFactory(String name, Map<String, String> properties)
    {
        _name       = name;
